...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_LEFT_GUI,    KC_RIGHT_ALT,   KC_TAB,         KC_ESCAPE,      KC_DELETE,      KC_BSPC,        LGUI(KC_H),                                     KC_TRANSPARENT, KC_TRANSPARENT, KC_DELETE,      KC_BSPC,        KC_ENTER,       KC_RIGHT_ALT,   KC_LEFT_GUI,
    ...
    KC_LEFT_CTRL,   KC_V,           KC_Z,           KC_M,           KC_D,           MO(6),          DUAL_FUNC_1,                                    LCTL(KC_W),     MO(6),          KC_W,           KC_SLASH,       KC_COMMA,       KC_DOT,         KC_LEFT_CTRL,
  ...
  [1] = LAYOUT_ergodox_pretty(
    KC_F3,          KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_6,                                           KC_TRANSPARENT, KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_BSPC,
    KC_F2,          KC_T,           KC_Q,           KC_W,           KC_E,           KC_R,           KC_ESCAPE,                                      KC_EQUAL,       KC_Y,           KC_U,           KC_I,           KC_O,           KC_P,           KC_BSLS,
    KC_F1,          KC_G,           KC_A,           KC_S,           KC_D,           KC_F,                                                                           KC_H,           KC_J,           KC_K,           KC_L,           KC_SCLN,        KC_QUOTE,
    KC_LEFT_SHIFT,  KC_B,           KC_Z,           KC_X,           KC_C,           KC_V,           KC_TAB,                                         KC_MINUS,       KC_N,           KC_M,           KC_COMMA,       KC_DOT,         KC_UP,          KC_SLASH,
    KC_TRANSPARENT, KC_BSPC,        KC_TRANSPARENT, KC_M,           KC_LEFT_CTRL,                                                                                                   KC_TRANSPARENT, KC_SLASH,       KC_LEFT,        KC_DOWN,        KC_RIGHT,
  ...
  [3] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_CTRL,   KC_LEFT_SHIFT,  KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_HOME,        KC_UP,          KC_END,         KC_TRANSPARENT, LSFT(KC_ENTER),
    KC_TRANSPARENT, KC_PSCR,        LGUI(KC_TAB),   LCTL(KC_TAB),   LALT(KC_TAB),   CW_TOGG,                                                                        KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_TRANSPARENT, KC_ENTER,
  ...
  [6] = LAYOUT_ergodox_pretty(
    ...
    KC_TRANSPARENT, KC_F5,          KC_F6,          KC_F7,          KC_F8,          KC_F15,                                                                         KC_MINUS,       KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_KP_5,        KC_TRANSPARENT,
    KC_TRANSPARENT, KC_F9,          KC_F10,         KC_F11,         KC_F12,         KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_NUM,         KC_TRANSPARENT, KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_DOT,      KC_TRANSPARENT,
...
const uint16_t PROGMEM combo2[] = { KC_S, KC_H, KC_T, COMBO_END};
const uint16_t PROGMEM combo3[] = { KC_C, KC_A, KC_E, COMBO_END};
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    [0] = { {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {23,255,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {23,255,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255}, {127,26,255} },

    [1] = { {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {43,255,249}, {245,255,255}, {245,255,255}, {43,255,249}, {43,255,249}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {74,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {74,255,255}, {74,255,255}, {74,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255}, {245,255,255} },

    [2] = { {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {245,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255}, {151,255,255} },

    [3] = { {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {74,255,255}, {129,255,166}, {129,255,166}, {129,255,166}, {74,255,255}, {74,255,255}, {74,255,255}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {74,255,255}, {74,255,255}, {129,255,166}, {74,255,255}, {129,255,166}, {129,255,166}, {129,255,166}, {74,255,255}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166}, {129,255,166} },
