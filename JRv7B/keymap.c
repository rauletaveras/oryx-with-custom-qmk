...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_voyager(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_DELETE,      KC_4,           KC_5,                                           KC_6,           KC_7,           KC_MINUS,       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    ...
    MO(4),          KC_V,           KC_Z,           KC_M,           KC_D,           QK_REP,                                           QK_REP,           KC_W,           KC_SLASH,       KC_COMMA,       KC_DOT,         MO(4),          
  ...
  [2] = LAYOUT_voyager(
    ...
    KC_TRANSPARENT, KC_DQUO,        KC_LPRN,        KC_RPRN,        KC_GRAVE,       KC_TILD,                                        ST_MACRO_0,     KC_AMPR,        KC_LBRC,        KC_RBRC,        KC_PERC,        LSFT(KC_ENTER), 
    ...
    KC_TRANSPARENT, KC_CIRC,        KC_ASTR,        KC_UNDS,        KC_BSLS,        KC_PIPE,                                        KC_DLR,         KC_COLN,        KC_LCBR,        KC_RCBR,        KC_SCLN,        KC_AT,          
  ...
  [4] = LAYOUT_voyager(
    KC_TRANSPARENT, OSM(MOD_LGUI),  OSM(MOD_LALT),  OSM(MOD_LSFT),  OSM(MOD_LCTL),  KC_F13,                                         KC_TRANSPARENT, OSM(MOD_LCTL),  OSM(MOD_LSFT),  OSM(MOD_LALT),  OSM(MOD_LGUI),  KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_F1,          KC_F2,          KC_F3,          KC_F4,          KC_F14,                                         KC_KP_PLUS,     KC_KP_7,        KC_KP_8,        KC_KP_9,        KC_TRANSPARENT, KC_NUM,         
    KC_TRANSPARENT, KC_F5,          KC_F6,          KC_F7,          KC_F8,          KC_F15,                                         KC_KP_MINUS,    KC_KP_1,        KC_KP_2,        KC_KP_3,        KC_TRANSPARENT, KC_KP_ENTER,    
    KC_TRANSPARENT, KC_F9,          KC_F10,         KC_F11,         KC_F12,         KC_F16,                                         KC_KP_ASTERISK, KC_KP_4,        KC_KP_5,        KC_KP_6,        KC_KP_DOT,      KC_TRANSPARENT, 
